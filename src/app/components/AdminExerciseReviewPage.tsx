      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-6 sm:pt-20 sm:pb-8 lg:pt-8 lg:pb-8">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-[10px] text-[14px] font-semibold transition-all flex items-center gap-2 ${
                filter === 'pending'
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-6">
          ...
          filteredExercises.map((exercise) => (
            <div
              key={exercise.id}
              className={`bg-white border-2 rounded-[16px] p-4 sm:p-6 transition-all ${
                          ...
                          <div className="flex items-center gap-1">
                            {[...Array(5)].map((_, i) => (
                              <Star
                                key={i}
                                className={`w-4 h-4 ${
                                  i < Math.round(exercise.score! / 20)
                  ...
                  <div className="flex items-center gap-1 mt-2">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className={`w-6 h-6 ${
                          i < Math.round((reviewScore / selectedExerciseData.maxScore) * 5)
                            ? 'text-[#FFD600] fill-[#FFD600]'
                            : 'text-[#E5E7EB]'
                        }`}
                      />
