import { Award, BookOpen, TrendingUp, Users, AlertTriangle, Clock, FileText, Briefcase, CheckCircle2, Target } from 'lucide-react';
                            ...
                            <div className="space-y-3">
                                ...
                                <Link to={routes.AdminExerciceReview.path} className="block w-full">
                                    <button className="w-full h-12 bg-white border-2 border-[#E8ECFF] text-[#1E1548] rounded-[12px] text-[14px] sm:text-[16px] font-semibold hover:bg-[#E8ECFF] transition-all flex items-center justify-between px-4">
                                        ...
                                        <span className="w-6 h-6 rounded-full bg-[#FFD600] text-[#1E1548] text-[12px] font-bold flex items-center justify-center">0</span>
                                    </button>
                                </Link>
                                ...
                                <Link to={routes.AdminSettings.path} className="block w-full">
                                    <button className="w-full h-12 bg-white border-2 border-[#E8ECFF] text-[#1E1548] rounded-[12px] text-[14px] sm:text-[16px] font-semibold hover:bg-[#E8ECFF] transition-all flex items-center justify-center px-4">
                                        ⚙️ Paramètres
                                    </button>
                                </Link>
                            </div>
